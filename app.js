    ...
    window.addEventListener("scroll", (e) => {
       ...
       let bodyStyleUnset = {
        ...
        if ((showcaseGalleryBottom - 500) < height) {
            ...
            // let showcaseMoreTextStyle = {
            //     transition: "opacity 650ms 650ms ease"
            // }

            // let { transition } = showcaseMoreTextStyle;
            showcaseMore.style.width = "100%";
            showcaseMoreText.style.opacity = 1; 

            // showcaseMoreText.style.transition = transition;
        } else {
            for (let i = 0; i < showcaseImages.length; ++i) {
